...
- **`KpiSection.tsx`**/**`ListSection.tsx`** are the same idea for the non-grid slide content — editable label/value tiles and editable ordered bullet lists (with up/down reorder), both add/delete-able since these change month to month (a new Wins bullet, a KPI that goes away).
