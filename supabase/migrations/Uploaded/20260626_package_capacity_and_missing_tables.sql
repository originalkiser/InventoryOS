...
-- =====================================================================
DROP FUNCTION IF EXISTS public.get_product_usage(uuid);
DROP FUNCTION IF EXISTS inventory.get_product_usage(uuid);
CREATE FUNCTION get_product_usage(p_company_id uuid)
RETURNS TABLE(
  id                  uuid,
  location_id         uuid,
  product_id          text,
